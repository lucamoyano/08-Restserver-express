...
const buscarUsuarios = async( termino = '', res) => {
    ...
    const regex = new RegExp( termino, 'i' ); // Expresion regular, buscar similares
...
const buscarProductos = async(termino = '', res) => {
    ...
    const productos = await Producto.find({ nombre: regex, estado: true }).populate('usuario categoria');
